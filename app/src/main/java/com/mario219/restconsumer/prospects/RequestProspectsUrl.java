...
public class RequestProspectsUrl implements RequestProspects {

    private static final String url = "http://directotesting.igapps.co/";
    private static final String TAG = RequestProspectsUrl.class.getSimpleName();

    public RequestProspectsUrl() {

    }

    @Override
    public void requestProspects(final RequestProspectsUrlCallback callback, String token){
